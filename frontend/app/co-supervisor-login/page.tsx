...
export default function CoSupervisorLogin() {
  ...
  const handleSubmit = async (e: { preventDefault: () => void; }) => {
    ...
    try {
      ...
      router.push('/co-supervisor-dashboard');
    } catch (err) {
      ...
      >
        <div className="text-center mb-8">
          ...
          <p className="mt-2 text-sm text-gray-600">
            Access your dashboard to support research and co-sign documents
          </p>
        </div>
          ...
          <div>
            ...
            <div className="mt-1">
              <input
                ...
                className="appearance-none block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 sm:text-sm"
                placeholder="co-supervisor@university.edu"
              />
            </div>
          </div>
        ...
        <div className="mt-6 text-center">
          <p className="text-sm text-gray-600">
            Not registered? <a href="#" className="font-medium text-indigo-600 hover:text-indigo-500">Contact the department</a>
          </p>
        </div>
