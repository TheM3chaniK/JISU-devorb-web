      ...
      >
        <div className="text-center mb-8">
          ...
          <p className="mt-2 text-sm text-gray-600">
            Access your dashboard to verify fees and issue clearance certificates
          </p>
        </div>
          ...
          <div>
            ...
            <div className="mt-1">
              <input
                ...
                className="appearance-none block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-teal-500 sm:text-sm"
        ...
        <div className="mt-6 text-center">
          <p className="text-sm text-gray-600">
            Need help? <a href="#" className="font-medium text-teal-600 hover:text-teal-500">Contact system support</a>
          </p>
        </div>
