...
export default function AssignedScholarsTable() {
  ...
  useEffect(() => {
    const fetchScholars = async () => {
      try {
        ...
        // ✅ Handles both: wrapped or direct array
        if (Array.isArray(data)) {
          setScholars(data);
        } else if (Array.isArray(data.assignedScholars)) {
          setScholars(data.assignedScholars);
        } else {
