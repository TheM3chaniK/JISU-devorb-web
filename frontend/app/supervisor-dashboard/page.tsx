            ...
            {modalContent.action !== 'view' && (
              <button
                ...
                className={`px-4 py-2 rounded-md text-white ${
                  modalContent.action === 'approve' ? 'bg-emerald-600 hover:bg-emerald-700' : 'bg-red-600 hover:bg-red-700'
                }`}
              >
      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col sm:flex-row justify-between items-center">
          ...
          <div className="flex space-x-4">
            <a href="#" className="text-emerald-600 hover:text-emerald-800 text-sm">Help Center</a>
            <a href="#" className="text-emerald-600 hover:text-emerald-800 text-sm">Terms and Conditions</a>
            <a href="#" className="text-emerald-600 hover:text-emerald-800 text-sm">Privacy Policy</a>
          </div>
        </div>
      </div>
    </footer>
      ...
      <header className="bg-white border-b border-gray-200 shadow-sm">
        <div className="container mx-auto px-4 py-4">
          <div className="flex justify-between items-center">
            <h1 className="text-2xl font-bold text-emerald-600">Supervisor Dashboard</h1>
