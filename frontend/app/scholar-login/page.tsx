      ...
      >
        <div className="text-center mb-8">
          ...
          <p className="mt-2 text-sm text-gray-600">
            Access your research dashboard to manage your doctoral journey
          </p>
        </div>
        ...
        <div className="mt-6 text-center">
          <p className="text-sm text-gray-600">
            New scholar? <a href="#" className="font-medium text-blue-600 hover:text-blue-500">Register for an account</a>
          </p>
        </div>
