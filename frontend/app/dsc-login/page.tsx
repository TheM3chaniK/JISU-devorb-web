...
export default function DSCLogin() {
      ...
      >
        <div className="text-center mb-8">
          ...
          <h2 className="text-2xl font-bold text-gray-800">
            Doctoral Scrutiny Committee Login
          </h2>
          <p className="mt-2 text-sm text-gray-600">
            Access your dashboard to evaluate progress reports and review thesis submissions
          </p>
        </div>
          ...
          <div>
            ...
            <div className="mt-1">
              <input
                ...
                className="appearance-none block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-purple-500 sm:text-sm"
                placeholder="dsc@university.edu"
              />
            </div>
          </div>
        ...
        <div className="mt-6 text-center">
          <p className="text-sm text-gray-600">
            Need help? <a href="#" className="font-medium text-purple-600 hover:text-purple-500">Contact the department</a>
          </p>
        </div>
